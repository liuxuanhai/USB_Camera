...
static int avi_write_data(avi_t *AVI, char *data, long length, int audio) {
    ...
    if (audio)
        ...
        n = avi_add_index_entry(AVI, (uint8 *)"00db", 0x10, AVI->pos, length);
...
int AVI_dup_frame(avi_t *AVI) {
    ...
    if (avi_add_index_entry(AVI, (uint8 *)"00db", 0x10, AVI->last_pos, AVI->last_len))
        return -1;
    AVI->video_frames++;
    ...
    if (idx_type == 0) {
        ...
        while (1) {
            ...
            if (((data[2] == 'd' || data[2] == 'D')
                    ...
                    || ((data[2] == 'w' || data[2] == 'W')
                            && (data[3] == 'b' || data[3] == 'B'))) {
                avi_add_index_entry(AVI, (uint8 *)data, 0,
